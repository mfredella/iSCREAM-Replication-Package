...
import com.metric.utility.LOCCompute;
...
public class ContractVisitor2 extends SolidityBaseVisitor<Void> {
    ...
    private HashMap<String, Totali> functionMetric = new HashMap<>();
    private HashMap<String, Totali> totaleContract = new HashMap<>();
    ...
    public Void visitModifierDefinition(@NotNull SolidityParser.ModifierDefinitionContext ctx) {
        ...
        Totali t = new Totali(contract, type, name, sloc, lloc, cloc, blank, cicli, numif, numKeyord, numPar, numOpA, numOpC, numAss, numVir, numPer, numSpace, identifier, mediaLenIdenTot, mediaLineLen, maxOccT, occT, numNumber, mediaLineIndentation, maxLineIndentation, maxLenIdentifier, maxLenLenght, maxChar);
        functionMetric.put(name, t);
        Totali t1 = new Totali(contractNameT, typeT, name, slocTot, llocTot, clocTot, blankTot, cicliTot, numIfTot, numKeyordTot, numParTot, numOpaTot, numOpCTot, numAssTot, numVirTot, numPerTot, numSpaceTot, identifierTot, mediaLenIdenTot, mediaLineLen, null, null, numNumberTot, mediaLineIndentation, maxLineIndentation, maxLenIdentifier, maxLenLenght, maxChar);
        totaleContract.put(contractNameT, t1);
    ...
    public HashMap<String, Totali> getTotaleContract() {
        return totaleContract;
    }

    public HashMap<String, Totali> getFunctionMetric() {
